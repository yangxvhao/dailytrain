package com.yangxvhao.demo.proxy.loadbalance;
...
public final class AliasMethod {
    ...
    public static void main(String[] args) {
        AliasMethod aliasMethod = new AliasMethod(Arrays.asList(0.1, 0.2, 0.3,0.4));
        int a = 0, b = 0, sum = 0;
        for (int i = 0; i < 10000; i++) {
            if (aliasMethod.next() == 2) {
                a++;
            } else {
                b++;
            }
